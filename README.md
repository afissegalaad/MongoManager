# MongoManager starts a cluster in one line of Python [![Build Status](https://travis-ci.org/yoanncouillec/MongoManager.svg?branch=release)](https://travis-ci.org/yoanncouillec/MongoManager)
